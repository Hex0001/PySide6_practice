...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonTextEdit.clicked.connect(self.onPushButtonTextEdit)  # TODO подключить слот для вывода текста из textEdit в plainTextEditLog при нажатии на кнопку
        ...
        self.spinBox.textChanged.connect(self.onSpinBoxChanged)  # TODO подключить слот для вывода значения в plainTextEditLog при изменении значения в spinBox
    ...
    def onPushButtonTextEdit(self): # TODO Самостоятельная реализация слотов для сигналов
    ...
    def onDateTimeEditChanged(self):
        self.plainTextEditLog.setPlainText(self.dateTimeEdit.text())
